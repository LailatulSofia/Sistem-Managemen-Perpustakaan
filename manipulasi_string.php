...
<html lang="id">
    ...
    <body>
        <div class="container mt-5">
            ...
            <?php
            //Data Buku
            $judul = "Pemograman Web dengan PHP dan My SQL";
            $pengarang = "BUDI RAHARJO";
            $deskripsi = "Buku ini membahas pemograman web menggunakan PHP dan My SQL secara lengkap dari dasar hingga Mahir";
            ?>
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <p><strong>Judul : <?php echo $judul?></strong></p>
                    <p><strong>Pengarang : <?php echo $pengarang?></strong></p>
                    <p><strong>Deskripsi : <?php echo $deskripsi;?></strong></p>
                </div>
            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <!-- substr())-->
                    <p><strong>Karakter Pertama Deskripsi: </strong><br/>
                    ...
                    <?php echo strpos(strtolower($judul), "web");?></p>
