...
<body>
    <div class="container mt-5">
        <h1 class="mb-4">
            <i class="bi bi-puzzle"></i> Modularisasi dengan Include & Require
        </h1>
        ...
        <div class="alert alert-info">
            ...
            <strong>Info:</strong> Halaman ini menggunakan function dari file 
            <code>functions.php</code> dan data dari file <code>data.php</code>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-1">
                                    <strong><?php echo $laporan["buku_termahal"]["judul"]; ?></strong>
                                </p>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-1">
                                    <strong><?php echo $laporan["buku_termurah"]["judul"]; ?></strong>
                                </p>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                ?>
                <p>
                    Ditemukan <strong><?php echo count($buku_stok_aman); ?></strong> buku dengan stok aman
                </p>
                <ul>
