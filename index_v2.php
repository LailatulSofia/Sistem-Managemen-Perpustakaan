...
<html lang="id">
    ...
    <body>
        <div class="card">
            <h1>Sistem Managemen Perpustakaan</h1>

            <div class="info">
                <p><strong>Dibuat oleh: </strong> <?php echo "Lailatul Sofia"; ?></p>
            ...
            $alamat_perpus  = "Jl. Pahlawan KM 5 Rowolaku, Kajen, Kab. Pekalongan";
            ...
            <div class="info">
                ...
                <p><strong>Total Buku: </strong><?php echo number_format($total_buku); ?></p>
                <p><strong>Total Anggota: </strong> <?php echo number_format($total_anggota); ?></p>
